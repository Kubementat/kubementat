...
-f "../../platform_config/${ENVIRONMENT}/monitoring/prometheus_values.encrypted.yaml" \
...
--create-namespace \
--namespace "${PROMETHEUS_DEPLOYMENT_NAMESPACE}" \
-f "../../platform_config/${ENVIRONMENT}/monitoring/prometheus_blackbox_exporter_values.encrypted.yaml" \
...
-f "../../platform_config/${ENVIRONMENT}/monitoring/grafana_values.encrypted.yaml" \
