...
NGINX_REVERSE_PROXY_DEPLOYMENT_NAME=$(jq -r '.NGINX_REVERSE_PROXY_DEPLOYMENT_NAME' "${PLATFORM_CONFIG_DIRECTORY}/${ENVIRONMENT}/${TEAM}/static.json")
NGINX_REVERSE_PROXY_HELM_CHART_VERSION=$(jq -r '.NGINX_REVERSE_PROXY_HELM_CHART_VERSION' "${PLATFORM_CONFIG_DIRECTORY}/${ENVIRONMENT}/${TEAM}/static.json")
NGINX_REVERSE_PROXY_HELM_DEPLOYMENT_TIMEOUT=$(jq -r '.NGINX_REVERSE_PROXY_HELM_DEPLOYMENT_TIMEOUT' "${PLATFORM_CONFIG_DIRECTORY}/${ENVIRONMENT}/${TEAM}/static.json")
